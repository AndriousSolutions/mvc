...
class MVController extends StatedWidgetState{
...
abstract class MCView{
  ...
  StatedWidget _widget;
  get widget => _widget ?? this;
  set widget(StatedWidget w) => _widget = w;
...
abstract class StatedWidget extends StatefulWidget {
  StatedWidget({ Key key }) : super(key: key);
...
class StatedWidgetState extends State<StatedWidget> with WidgetsBindingObserver{
